...
# /new-task — Load Plan → Worktree → TDD → Verify → Submit

## Overview

This command executes implementation work that was planned by `/new-plan`
(or any equivalent process that produced a SPEC.md and PLAN.md). All work
happens in an isolated git worktree. Submission is via PR or commit.
