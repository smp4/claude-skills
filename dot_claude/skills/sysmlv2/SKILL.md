...
- **Official examples**: `./examples/official/SysML-v2-Release`
- **Standard library, normative**: `./examples/official/SysML-v2-Release/sysml.library`
- **Example models in sysmlv2 language**: `./examples/official/SysML-v2-Release/sysml`
- **Example models in kerml language**: `./examples/official/SysML-v2-Release/kerml`
- **SysML v2 book**: `./sysmlv2_book.md`

## Community Resources

- **Sensmetry advent of SysML v2 blog**: https://sensmetry.com/advent-of-sysml-v2/ (web content, not cloned)
- **Sensmetry advent code examples**: `./examples/community/advent-of-sysml-v2`
- **Airbus Apollo 11 mission model**: `./examples/community/apollo-11-sysml-v2`
...
- **MBSE 2025 SysIDE demos**: `./examples/community/mbse2025_syside_demo`
...
- **MBSE 2025 Weilkiens metadata examples**: `./examples/community/mbse2025_weilkiens_metadata`
- **SantosLab HAMR SysMLv2/AADL models**: `./examples/community/sysmlv2-models`
...
- `./examples/curated/SysML-v2-Models`
- `./examples/curated/MBPLE`
- `./examples/curated/goodSysMLv2`
- `./examples/curated/SYSMODwithSysMLv2` (SYSMOD method, valid SysML v2)
- `./examples/curated/dont-panic-batmobile`
