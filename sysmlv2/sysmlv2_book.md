![](media/resources/title_page.jpg)

[]{#cover.xhtml}

::: {#cover.xhtml_cover-image}
![The SysML v2 Book](media/resources/title_page.jpg)
:::

[]{#verso_page.xhtml}

`<!-- If epub-verso-page-blurb-on-separate-page is false then we want the
       verso page to include the title page content -->`{=html} **The SysML v2 Book**
...
`<!-- role="doc-toc" is an ARIA role for a table of contents, added for a11y -->`{=html}

::: {.section .frontmatter .TableOfContents .frontmatter .toc role="doc-toc"}
<nav xmlns:epub="http://www.idpf.org/2007/ops" epub:type="landmarks" id="guide">

## Guide {#nav.xhtml_tocheader}
...
![](resources/images/frontmatter-vince-molnar.png)
:::::::::::::
...
<div class="highlight">
<pre><code> 1 abstract part def Part :&gt; Item {
 2     doc
 3     /* Part is the most general class of objects that represent all or a part of a system.
 4      * Part is the base type of all PartDefinitions. */
 5 
 6     ref self: Part :&gt;&gt; Item::self;
 7     part start: Part :&gt;&gt; Item::start;
 8     part done: Part :&gt;&gt; Item::done;
 9         
10     abstract port ownedPorts: Port[0..*] :&gt; ports, timeEnclosedOccurrences {
11         doc /* Ports that are owned by this Part. */
12     }
13     abstract ref action performedActions: Action[0..*] :&gt; actions, enactedPerformances {
14         doc /* Actions that are performed by this Part. */
15     }
16     abstract action ownedActions: Action[0..*] :&gt; actions, ownedPerformances {
17         doc /* Actions that are owned by this Part. */
18         ref part :&gt;&gt; this : Part = that as Part {
19             doc /* The &quot;this&quot; reference of an ownedAction is always its owning Part. */
20         }
21     }
22     abstract ref state exhibitedStates: StateAction[0..*] 
23     :&gt; stateActions, performedActions {
24         doc /* StateActions that are exhibited by this Part. */
25     }
26     abstract state ownedStates: StateAction[0..*] :&gt; stateActions, ownedActions {
27         doc /* StateActions that are owned by this Part. */
28     }
29 }</code></pre>
</div>
<figcaption>Figure 6.5. System Library element Part</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 concern def &#39;Consistent Usage&#39; {
 2     subject sysMLv2Certification;
 3     stakeholder sdo : OMG;
 4     require constraint {
 5         doc /* Correct understanding and 
 6              * dissemination of language across all disciplines */
 7     }
 8 }
 9 concern def &#39;SysML v2 Skills&#39; {
10     subject sysMLv2Certification;
11     stakeholder modeler : &#39;Modeling Practicioner&#39;;
12     require constraint {
13         doc /* Acquiring a skill set and 
14              * the opportunity to demonstrate knowledge*/
15     }
16 }
17 concern def &#39;SysML v2 Capabilities&#39; {
18     subject sysMLv2Certification;
19     stakeholder org : &#39;Engineering Organization&#39;;
20     require constraint {
21         doc /* Official SysML v2 proof of skills by applicants 
22              * and the possibility of proving the SysML v2 capability 
23              * of an organizational unit, for example for a tender. */
24     }
25 }</code></pre>
</div>
<figcaption>Figure 10.2. Stakeholder Certification Program</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &lt;UAVSBA&gt; &#39;UAV System Base Architecture&#39; {
 2     part def CommonUAV {
 3         attribute flightTime subsets ISQ::duration;
 4     }
 5     part def CommonControlStation;
 6     part def CommonUAVDock;
 7     part def UAVSystem {
 8         part uavs[*] : CommonUAV;
 9         part uavDocks[*] : CommonUAVDock;
10         part ctrlStation : CommonControlStation;
11         connect ctrlStation to uavs;
12         connect ctrlStation to uavDocks;
13         connect uavDocks to uavs;
14     }
15     part def UAVSystemContext {
16         part uavSystem : UAVSystem;
17         part environment : Environment;
18         part operator : Operator;
19         connect environment to uavSystem;
20         connect operator to uavSystem;
21     }
22     part def Environment;
23     part def Operator;
24 }</code></pre>
</div>
...
2     part def DroneSystemContext specializes UAVSBA::UAVSystemContext {
3         part droneSystem redefines uavSystem : DroneSystem;
4     }
5     part def DroneSystem specializes UAVSBA::UAVSystem {
6         part drones redefines uavs;
7     }
8 }</code></pre>
</div>
<figcaption>Figure 14.4. System Context (Textual Notation)</figcaption>
</figure>
</figure>
:::::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &lt;DSUC&gt; &#39;Drone System Use Cases&#39; {
 2     use case def &#39;Observe area by drone&#39; {
 3         subject droneSystem : DSRE::DroneSystem;
 4         actor operator : UAVSBA::Operator;
 5         objective { doc /* The drone system observes autonomously 
 6           a defined area and reports any incidents. */ }
 7         first start;
 8         then perform droneSystem.specifyArea;
 9         then perform droneSystem.flyToPosition;
10         then perform droneSystem.observeArea;
11         then done;
12     }
13     use case def &#39;Charge drone&#39; {
14         subject droneSystem : DSRE::DroneSystem;
15         actor operator : UAVSBA::Operator;
16         objective { doc /* Recharge the battery of a drone. */ }
17     }
18 }
19 package &lt;DSRE&gt; &#39;Drone System Requirements&#39; {
20     part def DroneSystem :&gt; UAVSBA::UAVSystem {
21         part drones :&gt;&gt; uavs;
22         action specifyArea;
23         action flyToPosition;
24         action observeArea;
25     }
26 }</code></pre>
</div>
<figcaption>Figure 14.9. Use Case (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 package &lt;DSRE&gt; &#39;Drone System Requirements&#39; {
 2     part def DroneSystemContext :&gt; UAVSBA::UAVSystemContext {
 3         part droneSystem : DroneSystem :&gt;&gt; uavSystem;
 4         use case observeAreaByDrone : DSUC::&#39;Observe area by drone&#39; {
 5             subject :&gt;&gt; droneSystem :&gt; droneSystem.drones;
 6             actor :&gt;&gt; operator :&gt; operator;
 7             
 8         }
 9         use case chargeDrone : DSUC::&#39;Charge drone&#39; {
10             subject :&gt;&gt; droneSystem :&gt; droneSystem.drones;
11             actor :&gt;&gt; operator :&gt; operator;
12         }
13     }
14 }</code></pre>
</div>
<figcaption>Figure 14.11. Use Cases owned by the system context (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &lt;DSPA&gt; &#39;Drone System Physical Architecture&#39; {
 2     part def DroneSystem :&gt; DSRE::DroneSystem {
 3         comment /* Redefine inherited actions in terms of actions of the components  */
 4         action :&gt;&gt; specifyArea {
 5             perform groundStation.specifyArea;
 6         }
 7         action :&gt;&gt; flyDroneToPosition {
 8             perform drones.flyToPosition;
 9         }
10         action :&gt;&gt; observeAreaByDrone {
11             perform drones.observeArea;
12         }
13         part :&gt;&gt; drones {
14             action flyToPosition;
15             action observeArea;
16             part camera {
17                 port cameraPort;
18             }
19             part engines [4];
20             part controlUnit;
21             part body;
22             part battery : Battery {
23                 satisfy DSRE::DroneSystemRequirements::uavFlightTime by self;
24             }
25             connection connect controlUnit to camera;
26             connection connect controlUnit to engines;
27             connection connect engines to battery;
28         }
29         part chargers [*] :&gt;&gt; uavDocks {
30             port powerPort;
31         }
32         connection connect chargers.powerPort to drones.battery.powerPort;
33         part groundStation :&gt;&gt; ctrlStation {
34             action specifyArea;
35         }
36         connection connect groundStation to drones.controlUnit;
37     }
38 }</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 package &lt;DSV&gt; &#39;Drone System Verification&#39; {
2     verification def &#39;Verify flight time&#39; {
3         subject drone : DSPA::Drone;
4         in requirement verifiedRequirement;
5         objective { verify verifiedRequirement; }
6         action testFlightTime;
7         return verdict = VerificationCases::PassIf(verifiedRequirement);
8     }
9 }</code></pre>
</div>
<figcaption>Figure 14.16. Verification Case (Textual Notation)</figcaption>
</figure>
</figure>
::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &lt;DSMP&gt; &#39;Drone System Project&#39; {
 2     occurrence def DroneProject {
 3         part baseSystemContext : UAVSBA::UAVSystemContext;
 4         requirement systemRequirements : DSRE::DroneSystemRequirements;
 5         part requirementsSystemContext : DSRE::DroneSystemContext;
 6         part systemContext : DSPA::DroneSystemContext;
 7         satisfy systemRequirements by systemContext.droneSystem;
 8         verification verifyFlighTime : DSV::&#39;Verify flight time&#39; {
 9             subject :&gt;&gt; drone = systemContext.droneSystem.drones;
10             in requirement :&gt;&gt; verifiedRequirement = systemRequirements.uavFlightTime;
11         }
12     }
13 }</code></pre>
</div>
<figcaption>Figure 14.18. Drone Modeling Project (Textual Notation)</figcaption>
</figure>
</figure>
::::::
:::::::::::::::::::::::::::::::::::::::::::::::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 package &lt;DSM&gt; &#39;Drone System Model&#39; {
2   package &lt;DSPA&gt; &#39;Drone System Physical Architecture&#39; {
3     part def Drone;
4   }
5   package &#39;Surveillance Drone Product&#39; {
6     part surveillanceDrone : &#39;Drone System Physical Architecture&#39;::Drone;
7   }
8 }</code></pre>
</div>
<figcaption>Figure 15.2. Namespaces and Names (Textual Notation)</figcaption>
</figure>
</figure>
...
4     }
5     package UAVSystem {
6         alias UAV for DSPA::Drone;
7         part uavPro : UAV;
8     }
9 }</code></pre>
</div>
<figcaption>Figure 15.3. Alias (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 package &lt;DSM&gt; &#39;Drone System Model&#39; {
 ...
 4         part def Charger;
 5     }
 6     package &#39;Surveillance Drone Product&#39; {
 7         private import DSPA::Drone;
 8         part surveillanceDrone : Drone;
 9         part charger : DSPA::Charger;
10     }
11 }</code></pre>
</div>
<figcaption>Figure 15.4. Element Import (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 package &lt;DSM&gt; &#39;Drone System Model&#39; {
 2     package &lt;DSRE&gt; &#39;Drone System Requirements&#39;;
 3     package &lt;DSPA&gt; &#39;Drone System Physical Architecture&#39; {
 4         private import DSRE::*;
 5         part def Drone;
 6         part def Charger;
 7     }
 8     package &#39;Surveillance Drone Product&#39; {
 9         private import DSPA::*;
10         part surveillanceDrone : Drone;
11         part charger : Charger;
12     }
13 }</code></pre>
</div>
<figcaption>Figure 15.5. Namespace Import (Textual Notation)</figcaption>
</figure>
</figure>
...
|                                                                                                              | <figure class="code" lang="en" dir="ltr">                                            |
|                                                                                                              | <div class="highlight">                                                              |
|                                                                                                              | <pre><code>part &lt;p1&gt; p2 : P::C;</code></pre>                                   |
|                                                                                                              | </div>                                                                               |
|                                                                                                              | </figure>                                                                            |
|                                                                                                              | </figure>                                                                            |
|                                                                                                              |                                                                                      |
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 // This is a note.
2 
3 // some model experiments
4 part drone {
5     part engine[4];
6     // part engine[6];
7     // part engine[8];
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def &#39;Mobile Charger&#39; {
 2     comment Structure about body, dronePlatform 
 3       /* Body represents structure without the dronePlatform. */
 4     part &#39;wheels[6] : Wheel&#39; {
 5         comment SixWheels 
 6           /* Six wheels provide stable support and traction. */
 7     }
 8     part chargingUnit;
 9     part body;
10     part dronePlatform {
11       /* Serves as landing and charging interface for drones */
12     }
13 }</code></pre>
</div>
<figcaption>Figure 15.8. Comments (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 calc def FastFourierTransformation {
2     in signal;
3     rep fft language &quot;python&quot; 
4        /* import numpy as np 
5         * return np.fft.fft(signal)
6         */
7 }</code></pre>
</div>
<figcaption>Figure 15.12. Textual Representation (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 package &lt;DSM&gt; &#39;Drone System Model&#39; {
 2     dependency DependsOnBaseArchitecture from DSRE to DSBA {
 3         doc /* Specifies that the system requirements depend on the base architecture. */
 4     }
 5     dependency from DSPA, DSFA to DSRE;
 6 
 7     package &lt;DSFA&gt; &#39;Drone System Functional Architecture&#39;;
 8     package &lt;DSBA&gt; &#39;Drone System Base Architecture&#39;;
 9     package &lt;DSRE&gt; &#39;Drone System Requirements&#39;;
...
<div class="highlight">
<pre><code> 1 package &lt;DSM&gt; &#39;Drone System Model&#39; {
 2     package &lt;DSP&gt; &#39;Drone System Project&#39;;    
 3     package &lt;DSNEEDS&gt; &#39;Drone System Stakeholder Needs&#39;;
 4     package &lt;DSD&gt; &#39;Drone System Domain&#39;;    
 5     package &lt;DSBA&gt; &#39;Drone System Base Architecture&#39;;
 6     package &lt;DSS&gt; &#39;Drone System&#39;;
 7     package &lt;DSLA&gt; &#39;Drone System Logical Architecture&#39;;
 8     package &lt;DSRE&gt; &#39;Drone System Requirements&#39;;
 9     package &lt;DSFA&gt; &#39;Drone System Functional Architecture&#39;;    
10     package &lt;DSUC&gt; &#39;Drone System Use Cases&#39;;    
11     package &lt;DSPA&gt; &#39;Drone System Product Architecture&#39;;
12 }</code></pre>
</div>
<figcaption>Figure 16.1. Package Structure (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 standard library package SI {
2 	doc
3 	/*
4 	 * International System of (Measurement) Units 
5 	 * Système International d&#39;Unités (SI), as defined in ISO/IEC 80000
6 	 *
7 [...]
8 }</code></pre>
</div>
<figcaption>Figure 16.3. Standard Library Package SI (Textual Notation)</figcaption>
</figure>
</figure>
::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 package &#39;Drone Calculations&#39; {
2     private import ISQ::*; // importing library quantities
3     private import $::SI::*; // importing library units
4     private import SI::*; // importing from local package
5 
6     package SI {
7         //...
8     }
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 part def Drone { // A (part) definition
2     part mainBattery : Battery [1]; // A (part) usage
3     part backupBatteries [*] defined by Battery; // Another (part) usage
4 }
5 part def Battery;</code></pre>
</div>
<figcaption>Figure 17.1. Definitions and Usages (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 abstract part def Battery {
2     attribute capacity :&gt; ISQElectromagnetism::electricCharge;
3 }
4 part def LiIonBattery :&gt; Battery;</code></pre>
</div>
<figcaption>Figure 17.3. Definitions (Textual Notation)</figcaption>
</figure>
</figure>
...
+--------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  ...
  -------------------------------------- -----------------------------
        ...
        value type/value property           attribute def/attribute
        interface block/proxy port               port def/port
       association block/connector         connection def/connection
              requirement/--              requirement def/requirement
             activity/action                   action def/action
           state machine/state                  state def/state
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 attribute mySet [*]; // unordered, unique
2 attribute myBag [*] nonunique; // unordered, non-unique
3 attribute myLinkedSet[*] ordered; // ordered, unique
4 attribute  myList [*] ordered nonunique; // ordered, non-unique;</code></pre>
</div>
<figcaption>Figure 17.6. Combinations of uniqueness and orderedness</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 part def Drone {
2     abstract part engines [4];
3     part engine1 [1] :&gt; engines;
4     part engine2 [1] :&gt; engines;
5     part engine3 [1] :&gt; engines;
6     part engine4 [1] :&gt; engines;
7 }</code></pre>
</div>
<figcaption>Figure 17.7. Abstract Usages (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code>1 part def Drone {
2     attribute currentSpeed :&gt; ISQSpaceTime::speed;
3     constant attribute mass :&gt; ISQBase::mass;
4 }</code></pre>
</div>
<figcaption>Figure 17.9. Variable and Constant Usages (Textual Notation)</figcaption>
</figure>
</figure>
::::
...
<div class="highlight">
<pre><code>1 part def Drone {
2 	part engine1 [1] :&gt; engines;
3 	ref part operator;
4 	mission;
5 }</code></pre>
</div>
<figcaption>Figure 17.10. Composite and Referential Usages and a Reference Usage (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 part def UAV {
 2     // Assignment: Fixed initial value
 3     attribute standardSpeed :&gt; ISQ::speed := 42 [SI::&#39;km/h&#39;];
 4     // Assignment: Default value
 5     attribute currentSpeed :&gt; ISQ::speed default := 0 [SI::&#39;km/h&#39;];
 6     // Binding: Fixed
 7     attribute maxSpeed :&gt; ISQ::speed = 60 [SI::&#39;km/h&#39;];
 8     // Binding: Default
 9     attribute lowerSpeedLimit :&gt; ISQ::speed default = 30 [SI::&#39;km/h&#39;];
10     attribute upperSpeedLimit :&gt; ISQ::speed default 30 [SI::&#39;km/h&#39;];
11 }</code></pre>
</div>
<figcaption>Figure 17.12. Assignment vs. Binding (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def SpecialUAV :&gt; UAV {
 2     // For example, an action can change the initial value
 3     perform action changeStandardSpeed {
 4         in attribute speedSetting;
 5         standardSpeed := speedSetting;
 6     }
 7     // A default value can be changed by redefinition.
 8     attribute :&gt;&gt; currentSpeed := 25;
 9     // Default bindings can be changed by redefinition.
10     attribute :&gt;&gt; lowerSpeedLimit = 10;
11     attribute :&gt;&gt; upperSpeedLimit = 50;
12 
13     // The following lines are invalid (and therefore commented out).
14     
15     // An initial value cannot be changed by redefinition.
16     // attribute :&gt;&gt; standardSpeed := 40; 
17     // A fixed binding cannot be changed by redefinition.
18     // attribute :&gt;&gt; maxSpeed = 80;
19 }</code></pre>
</div>
<figcaption>Figure 17.13. Redefinition with Assignment and Binding (Textual Notation)</figcaption>
</figure>
</figure>

  **Kind**             **Syntax**                 **Description**
  -------------------- -------------------------- -----------------------------------------------------------------------------------------------------------------------------------------------------------
  Fixed assignment     *:=*                       Assignment of an initial value. It can be changed later, e.g., by an action, but not overridden in a redefinition.
  Default assignment   *default :=*               Assignment of a default initial value. It can be changed later, and it can be overridden in a redefinition.
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 // There are Engines in the world
 2 part def Engine {
 3     // Engines have a power
 4     attribute power;
 5 }
 6 // There are also Drones
 7 part def Drone {
 8     // Drones have a powerSource that is an Engine.
 9     part powerSource : Engine {
10         // The thrust vector of the powerSources of Drones...
11         attribute thrustVector;
12     }
13 }</code></pre>
</div>
<figcaption>Figure 17.15. Illustration of how to model based on natural language sentences.</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 part def CommonUAV {
2     attribute callsign : ScalarValues::String;
3 }
4 part def Drone :&gt; CommonUAV {
5     attribute flightStatus : FlightStatus;
6 }</code></pre>
</div>
<figcaption>Figure 18.2. Subclassification (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def Entity {
 2     attribute identifier;
 3 }
 4 part def Agent :&gt; Entity {
 5     attribute :&gt;&gt; identifier : ScalarValues::String;
 6 }
 7 part def CommonUAV :&gt; Entity {
 8     attribute callsign :&gt;&gt; identifier;
 9 }
10 part def Drone :&gt; CommonUAV, Agent {
11     attribute callsign :&gt;&gt; callsign, identifier;
12 }</code></pre>
</div>
<figcaption>Figure 18.4. An example for multiple subclassifications and diamond inheritance.</figcaption>
</figure>
</figure>
:::::::
...
<div class="highlight">
<pre><code>1 part def Drone {
2     abstract part engines [4] : Engine;
3     part engine1 [1] :&gt; engines;
4     part engine2 [1] subsets engines;
5     part engine3 :&gt; engines [1];
6     part engine4 subsets engines [1];
7 }</code></pre>
</div>
<figcaption>Figure 18.5. Subsetting (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 action flyToPosition;
2 perform action callFlyToPosition ::&gt; flyToPosition;
3 perform action performFlyToPosition references flyToPosition;</code></pre>
</div>
<figcaption>Figure 18.7. Reference Subsetting (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 part def CommonUAV {
 2     part engines [1..*] : Engine;
 3     attribute mass;
 4     item payload [*];
 5 }
 6 
 7 part def Drone :&gt; CommonUAV {
 8     part droneEngines redefines engines [4];
 9     attribute :&gt;&gt; mass :&gt; ISQ::mass;
10     :&gt;&gt; payload ordered;
11 }</code></pre>
</div>
<figcaption>Figure 18.9. Redefinition (Textual Notation)</figcaption>
</figure>
</figure>
...
<figcaption>Figure 18.11. An Example for Diamond Inheritance</figcaption>
</figure>
</figure>
...
3 action def Fly;
4 
5 // This is still correct
6 part drone : CommonUAV, Agent;
7 // This is an error because parts and actions are disjoint
8 part flyingAgent : Agent, Fly;</code></pre>
</div>
<figcaption>Figure 18.13. An Example for Multiple Definitons</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 item def Payload {
 2     attribute mass :&gt; ISQBase::mass = box.mass + content.mass;
 3     attribute description : ScalarValues::String;
 4     item box : PackageBox;
 5     item content : PayloadContent;
 6 }
 7 item def PackageBox {
 8     attribute mass :&gt; ISQBase::mass;
 9 }
10 item def PayloadContent {
11     attribute mass :&gt; ISQBase::mass;
12 }</code></pre>
</div>
<figcaption>Figure 19.2. Item Definition (Textual Notation)</figcaption>
</figure>
</figure>
...
![Figure 19.3. Owned Item (General View)](resources/images/part2/FigPayloadAttachment.png){alt="Owned Item (General View)"}

<figure>
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 part def PayloadAttachment {
2     item payload[0..1] : Payload;
3 }</code></pre>
</div>
<figcaption>Figure 19.4. Owned Item (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def &#39;Drone System&#39; {
 2     part drones [*] : Drone {
 3         connect powerDistributionSystem to battery;
 4         connect powerDistributionSystem to engines;
 5     }
 6     part transportBox : &#39;Drone Transport Box&#39;;
 7     part chargers [*] : Charger;
 8     connect chargers to drones.battery;
 9 }
10 
11 part def Drone :&gt; DSBA::CommonUAV {
12     part engines [*];
13     part navigationModule {
14         part navigationApp;
15     }
16     part powerDistributionSystem : PowerDistributionSystem;
17     part battery : Battery;
18     part body {
19         part &#39;frame&#39;;
20         part payloadAttachment : PayloadAttachment;
21     }
22 }</code></pre>
</div>
<figcaption>Figure 19.8. Parts (Textual Notation)</figcaption>
</figure>
</figure>
::::::::::
::::::::::::::::::::::
...
<pre><code>1 part def Drone {
2     part engines [*];
3     part battery : Battery;
4     connect battery to engines;
5 }
6 part def Battery;</code></pre>
</div>
<figcaption>Figure 20.2. Connection (Textual Notation)</figcaption>
</figure>
</figure>
...
2     part engines [*];
3     part battery : Battery;
4     connection powerDistribution {
5         end part powerSource references battery;
6         end part powerTarget ::&gt; engines;
7     }
8 }
9 part def Battery;</code></pre>
</div>
<figcaption>Figure 20.3. Connection (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 part def Drone {
 2     part engines [*];
 3     part battery : Battery;
 4     part powerElements [*];
 5     connection powerDistribution {
 6         end part powerSource :&gt; powerElements ::&gt; battery;
 7         end part powerTarget :&gt; powerElements ::&gt; engines;
 8     }
 9 }
10 part def Battery;</code></pre>
</div>
<figcaption>Figure 20.5. Connection with Reference Subsetting and Subsetting (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 part def Drone {
 ...
 3     part battery : Battery;
 4 
 5     connection powerDistribution : PowerDistribution 
 6       connect powerSource ::&gt; battery to powerTarget ::&gt; engines;
 7       // If the assignment is clear, the connect statement can also be shorter:
 8       // connect battery to engines;
 9       
10 }
11 part def Battery :&gt; PowerProducer;
12 part def PowerProducer;
13 part def PowerConsumer;
14 
15 connection def PowerDistribution {
16     end part powerSource : PowerProducer;
17     end part powerTarget : PowerConsumer;
18 }</code></pre>
</div>
<figcaption>Figure 20.7. Connection Definition (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 part def Drone {
 2     part engines [*] : PowerConsumer;
 3     part battery : Battery;
 4     connection powerDistribution : PowerDistribution 
 5       connect battery to engines;  
 6 }
 7 part def Battery :&gt; PowerProducer;
 8 part def PowerProducer {
 9     ref part consumers[*] : PowerConsumer;
10 }
11 part def PowerConsumer {
12     ref part producer : PowerProducer;
13 }
14 connection def PowerDistribution {
15     end part powerSource : PowerProducer crosses powerTarget.producer;
16     end part powerTarget : PowerConsumer =&gt; powerSource.consumers;
17 }</code></pre>
</div>
<figcaption>Figure 20.8. Connection Definition (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 part def Drone {
 ...
 4 
 5     connection powerDistribution : PowerDistribution 
 6       connect battery to engines;
 7       
 8 }
 9 part def Battery :&gt; PowerProducer;
10 part def PowerProducer;
11 part def PowerConsumer;
12 connection def PowerDistribution {
13     end producer[1] part powerSource : PowerProducer;
14     end consumers[1..*]  part powerTarget : PowerConsumer;
15 }</code></pre>
</div>
<figcaption>Figure 20.9. Connection with owned cross features (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 part def Drone {
 2     part engines [*] : PowerConsumer;
 3     part battery : Battery;
 4     part powerControlUnit : PowerController;
 5 
 6     connection powerDistribution : PowerDistribution 
 7       connect (powerSource ::&gt; battery, 
 8                powerTarget ::&gt; engines, 
 9                controller ::&gt; powerControlUnit);
10       
11 }
12 part def Battery :&gt; PowerProducer;
13 part def PowerProducer;
14 part def PowerConsumer;
15 part def PowerController;
16 connection def PowerDistribution {
17     end producer[1] part powerSource : PowerProducer;
18     end consumer[1..*] part powerTarget : PowerConsumer;
19     end controller : PowerController;
20 }</code></pre>
</div>
<figcaption>Figure 20.11. Connection with three ends (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 part def Drone {
 2     part engines [*] : PowerConsumer;
 3     part battery : Battery;
 4     connection powerDistribution : PowerDistributionImpl 
 5       connect battery to engines;      
 6 }
 7 part def Battery :&gt; PowerProducer;
 8 part def PowerProducer;
 9 part def PowerConsumer;
10 part def PowerController;
11 connection def PowerDistribution {
12     end producer[1] part powerSource : PowerProducer;
13     end consumer[1..*] part powerTarget : PowerConsumer;
14 }
15 connection def PowerDistributionImpl :&gt; PowerDistribution {
16     attribute voltage :&gt; ISQ::voltage = 240 [SI::V];
17     part controller : PowerController;
18     connect controller to powerSource;
19     connect controller to powerTarget;
20 }</code></pre>
</div>
<figcaption>Figure 20.14. Connection with parts (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 port def EnergyPort {
 2     out item electricalEnergy : ElectricalEnergy;
 3     attribute nominalVoltage :&gt; ISQ::voltage;
 4     attribute allowableVoltageVariation : ScalarValues::Real default 0.1;
 5     ref assert constraint {
 6         NumericalFunctions::abs(electricalEnergy.voltage - nominalVoltage) 
 7           &lt;= nominalVoltage * allowableVoltageVariation    
 8     }
 9 }
10 item def ElectricalEnergy {
11     attribute voltage :&gt; ISQ::voltage;
12 }</code></pre>
</div>
<figcaption>Figure 22.1. Port Definition (Textual Notation)</figcaption>
</figure>
</figure>
...
![Figure 22.2. Port Usages (General View)](resources/images/part2/FigPortUsages.png){alt="Port Usages (General View)"}

<figure>
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def Battery {
 2     port energyOutPort : EnergyPort {
 3         attribute :&gt;&gt; nominalVoltage = 22.2 [SI::V];
 4     }
 5     port chargeInPort : ~EnergyPort {
 6         attribute :&gt;&gt; nominalVoltage = 240 [SI::V];
 7     }
 8 }
 9 part def PowerDistributionSystem {
10     port energyInPort : ~EnergyPort {
11         attribute :&gt;&gt; nominalVoltage = 22.2 [SI::V];
12     }
13 }
14 part def Drone {
15     part battery : Battery;
16     part powerDistributionSystem : PowerDistributionSystem;
17     interface powerInterface connect battery.energyOutPort 
18       to powerDistributionSystem.energyInPort {
19         flow of ElectricalEnergy from battery.energyOutPort.electricalEnergy 
20           to powerDistributionSystem.energyInPort.electricalEnergy;
21     }
22     port chargePort : ~EnergyPort {
23         attribute :&gt;&gt; nominalVoltage = 240 [SI::V];
24     }
25     bind chargePort = battery.chargeInPort;
26 }</code></pre>
</div>
<figcaption>Figure 22.3. Port Usages (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code>1 part def Drone {
2     attribute flightStatus : FlightStatus;
3 }
4 attribute def FlightStatus {
5     attribute speed;
6     attribute altitude;
7     ref attribute flightTime;
8     attribute &lt;erft&gt; estimatedRemainingFlightTime;
9 }</code></pre>
</div>
<figcaption>Figure 23.2. Attribute Definition and Usage(Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 enum def LevelKind :&gt; ScalarValues::Integer {
 2     undefined = 0;
 3     low = 1;
 4     middle = 2;
 5     high = 3;
 6 }
 7 enum def StakeholderCategoryKind {
 8     Expert;
 9     RequirementOwner;
10     User;
11     Other;
12 }
13 part def CommonStakeholder {
14     attribute risk : LevelKind;
15     attribute effort : LevelKind;
16     derived attribute priority : ScalarValues::Integer = risk * effort;
17     attribute kind : StakeholderCategoryKind;
18     attribute contact : ScalarValues::String;
19 }</code></pre>
</div>
<figcaption>Figure 23.4. Enumeration Definition (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 part def Drone {
 2     attribute actualMass :&gt; ISQ::mass = 50[SI::kg];
 3     assert constraint {
 4         actualMass &lt;= 62000 [SI::g]
 5     }
 6     attribute def FlightStatus {
 7         attribute speed :&gt; ISQ::speed;
 8         attribute altitude :&gt; ISQ::height;
 9         attribute flightTime :&gt; ISQ::duration;
10         attribute &lt;erft&gt; estimatedRemainingFlightTime :&gt; ISQ::duration;
11     }    
12 }</code></pre>
</div>
<figcaption>Figure 24.4. Quantities and Units (Textual Notation)</figcaption>
</figure>
</figure>
::::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 abstract action def Land {
 2     action approachLandingZone;
 3 }
 4 action def NormalLanding :&gt; Land;
 5 action def EmergencyLanding :&gt; Land {
 6     action :&gt;&gt; approachLandingZone [0];
 7 }
 8 
 9 part def Drone {
10     abstract action land : Land;
11     action normalLanding : NormalLanding :&gt; land;
12     action emergencyLanding : EmergencyLanding :&gt; land;
13 }</code></pre>
</div>
<figcaption>Figure 26.1. Action Definition and Usage (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 action def FlyToPosition {
 2     in constant attribute targetLat : ScalarValues::Real;
 3     in constant attribute targetLon : ScalarValues::Real;
 4     out attribute currLat : ScalarValues::Real;
 5     out attribute currLon : ScalarValues::Real;
 6 }
 7 action def PerformMission {
 8     action flyToPosition : FlyToPosition {
 9         in :&gt;&gt; targetLat = 53.874485;
10         in targetLon = 10.206088;
11     }
12     action monitorPosition {
13         in currLat = flyToPosition.currLat;
14         in currLon = flyToPosition.currLon;
15     }
16 }</code></pre>
</div>
<figcaption>Figure 26.3. Action Parameters (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 action def PerformMission {
 2     action flyToPosition : FlyToPosition;
 3 
 4     first start;
 5     then action takeOff;
 6     then flyToPosition;
 7     succession s first flyToPosition then observeArea;
 8     action observeArea;
 9     then action returnHome;
10     then action land;
11     then done;
12 }</code></pre>
</div>
<figcaption>Figure 26.6. Successions (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 action def EvaluateTarget {
 2     first start;
 3     then fork;
 4         then observeByCamera;
 5         then observeByLidar;
 6         // First thread
 7         action observeByCamera;
 8             then j;
 9         // Second thread
10         action observeByLidar;
11             then j;
12     join j;
13     then decide;
14         then signalTargetFound;
15         then signalTargetNotFound;
16         // First branch
17         action signalTargetFound;
18             then m;
19         // Second branch
20         action signalTargetNotFound;
21             then m;
22     merge m;
23     then done;
24 }</code></pre>
</div>
<figcaption>Figure 26.7. Control Nodes (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 action def EvaluateTarget {
 ...
 5         then observeByLidar;
 6         // First thread
 7         action observeByCamera { out attribute targetIdentified : ScalarValues::Boolean; }
 8             then j;
 9         // Second thread
10         action observeByLidar { out attribute targetIdentified : ScalarValues::Boolean; }
11             then j;
12     join j;
13     then decide;
14         if observeByCamera.targetIdentified and observeByLidar.targetIdentified 
15             then signalTargetFound;
16         else signalTargetNotFound;
17         // First branch
18         action signalTargetFound;
19             then m;
20         // Second branch
21         action signalTargetNotFound;
22             then m;
23     merge m;
24     then done;
25 }</code></pre>
</div>
<figcaption>Figure 26.9. Conditional Succession (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 action def ObserveTarget {
 2     first start;
 3     then action checkSubsystems {
 4         out attribute cameraOperational : ScalarValues::Boolean;
 5         out attribute lidarOperational : ScalarValues::Boolean;
 6     }
 7         if checkSubsystems.cameraOperational then observeByCamera;
 8         if checkSubsystems.lidarOperational then observeByLidar;
 9     
10     action observeByCamera;
11     action observeByLidar;
12 }</code></pre>
</div>
<figcaption>Figure 26.11. Conditional Succession Without Decision (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 part def MissionCounter {
2     attribute completedMissions : ScalarValues::Integer := 0;
3     action completeMission {
4         :&gt;&gt; this : MissionCounter;
5         assign this.completedMissions := completedMissions + 1;
6     }
7 }</code></pre>
</div>
<figcaption>Figure 26.13. Assignment Action (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def DroneSystem {
 2     item def Message;
 3     part drone {
 4         port commPort;
 5         action signalGroundStation {
 6             send new Message() via commPort to groundStation.commPort;
 7         }
 8     }
 9     part groundStation {
10         port commPort;
11         action listenToDrone {
12             accept msg : Message via commPort;
13         }
14     }
15     interface connect drone.commPort to groundStation.commPort;
16 }</code></pre>
</div>
<figcaption>Figure 26.15. Send and Accept Actions (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 action def NotifyGroundStation {
 2     in attribute nominalOperation : ScalarValues::Boolean;
 3     action detectError accept when nominalOperation == false;
 4         then m;
 5     action detectMissionEnd accept at Time::Iso8601DateTime(&quot;2025-09-30T00:00:00Z&quot;);
 6         then m;
 7     action detectDeadline accept after 5 [SI::h];
 8         then m;
 9     merge m;
10     then action signalGroundStation; 
11 }</code></pre>
</div>
<figcaption>Figure 26.17. Special Accept Actions (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 part def Drone {
 2     action performMission {
 3         first start;
 4         then fork;
 5             then monitorDrone;
 6             then performTasks;
 7             // Tread 1
 8             action monitorDrone {
 9                 first start;
10                 then accept CatastrophicFailure;
11                 then selfDestruct terminate this; // terminates Drone
12             }
13             // Thread 2
14             action performTasks;
15                 then terminate; // terminates performMission
16     }
17 }</code></pre>
</div>
<figcaption>Figure 26.19. Terminate Action (Textual Notation)</figcaption>
</figure>
</figure>
:::::
...
12     join j;
13     
14     then if observeByCamera.targetIdentified and observeByLidar.targetIdentified {
15         action signalTargetConfirmed;
16     } else if observeByCamera.targetIdentified or observeByLidar.targetIdentified {
17         action signalTargetPartiallyConfirmed;
18     } else {
19         action signalTargetNotFound;
20     }
21     then done;
22 }</code></pre>
</div>
<figcaption>Figure 26.20. If Action (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package WhileLoop {
 2     action def FindTarget {
 3         attribute targetConfirmed : ScalarValues::Boolean := false;
 4         while not targetConfirmed {
 5             action acquireTarget;
 6             then action evaluateTarget : EvaluateTarget;
 7         }
 8     }
 9 }
10 package UntilLoop {
11     action def FindTarget {
12         attribute targetConfirmed : ScalarValues::Boolean := false;
13         loop {
14             action acquireTarget;
15             then action evaluateTarget : EvaluateTarget;
16         } until targetConfirmed;
17     }
18 }</code></pre>
</div>
<figcaption>Figure 26.22. While and Until Loops (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 action def FindTarget {
 2     in item targetCandidates [*];
 3     for target in targetCandidates {
 4         action robustEvaluation for i : Integer in 1..3 {
 5             action evaluateTarget {
 6                 in item candidate = target;
 7             }
 8         }
 9     }
10 }</code></pre>
</div>
<figcaption>Figure 26.24. For Loop (Textual Notation)</figcaption>
</figure>
</figure>
...
![Figure 26.25. For Loop (Graphical Notation)](resources/images/FigG-ForLoop.png){alt="For Loop (Graphical Notation)"}
:::::::::::::::
::::::::::::::::::::::::::::::::::::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def DroneSpecification {
 2     action performMission {
 3         perform action flyToPosition;
 4         action observeArea;
 5     }
 6 }
 7 
 8 part def DroneDesign :&gt; DroneSpecification {
 9     part navigationSystem {
10         action flyToPosition;
11     }
12     part observationSystem {
13         perform performMission.observeArea;
14     }
15 
16     action :&gt;&gt; performMission {
17         perform action :&gt;&gt; flyToPosition references navigationSystem.flyToPosition;
18     }
19 }</code></pre>
</div>
<figcaption>Figure 26.26. Perform Actions (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 state def DroneStates {
 2     :&gt;&gt; this : Drone;
 3     in attribute windSpeed :&gt; ISQSpaceTime::speed;
 4     entry ;
 5         then off;
 6     state off;
 7         transition turnOn 
 8             first off accept TurnOn via this.commPort 
 9             then on;
10     state on {
11         entry action {
12             action initialize;
13         }
14             then idle;
15         state idle;
16             accept StartMission 
17                 if windSpeed &lt; 20 [SI::&#39;km/h&#39;] 
18                 do action send new MissionStarted() via this.commPort 
19                 then flying;
20         state flying {
21             entry action : TakeOff;
22             do action {
23                 first start;
24                 then action performMission;
25             }
26             exit action : Land;
27         }
28         transition timeout
29             first flying
30             accept after 2 [SI::h] 
31             do action send new MissionTimeout() via this.commPort 
32             then idle;
33     }
34     transition turnOff first on accept TurnOff then off;
35 }</code></pre>
</div>
<figcaption>Figure 28.2. A State Machine (Textual Notation)</figcaption>
</figure>
</figure>
...
12             then idle;
13         state idle;
14             accept StartMission 
15                 if windSpeed &lt; 20 [SI::&#39;km/h&#39;] 
16                 do action send new MissionStarted() via this.commPort 
17                 then flying;
18         state flying;
19         transition timeout
20             first flying
21             accept after 2 [SI::h] 
22             do action send new MissionTimeout() via this.commPort 
23             then idle;
24     }
25     transition turnOff first on accept TurnOff then off;
26 }</code></pre>
</div>
<figcaption>Figure 28.4. Transitions (Textual Notation)</figcaption>
</figure>
</figure>
...
![Figure 28.5. Parallel State (Graphical Notation)](resources/images/FigG-ParallelStates.png){alt="Parallel State (Graphical Notation)"}

<figure>
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 state flying parallel {
 2     entry action : TakeOff;
 3     do action {
 4         first start;
 5         then action performMission;
 6     }
 7     exit action : Land;
 8     
 9     state positioning {
10         entry;
11             then stabilizing;
12         state stabilizing;
13             transition stabilizing then moving;
14         state moving;
15             transition moving then stabilizing;
16     }
17     state observing {
18         entry;
19             then idle;
20         state idle;
21             transition idle then observing;
22         state observing;
23             transition observing then idle;
24     }
25 }</code></pre>
</div>
<figcaption>Figure 28.6. Parallel State (Textual Notation)</figcaption>
</figure>
</figure>
::::::::
...
<pre><code> 1 part def Drone {
 2     port commPort;
 3     state droneStates : DroneStates;
 4     part navigationSystem {
 5         exhibit state navigation ::&gt; droneStates.on.flying.positioning;
 6     }
 7     part observationSystem {
 8         exhibit droneStates.on.flying.observing;
 9     }
10 }</code></pre>
</div>
<figcaption>Figure 28.8. Exhibit States (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 abstract flow def HeatFlow {
 2     ref item heat : Heat :&gt;&gt; payload;
 3 }
 4 flow def HeatInterfaceFlow :&gt; HeatFlow {
 5     end heatPortSource : HeatPort; 
 6     end heatPortTarget : HeatPort;
 7 }
 8 port def HeatPort {
 9     out item heat : Heat;
10 }
11 item def Heat {
12     attribute heatEnergy :&gt; ISQ::heat;
13 }</code></pre>
</div>
<figcaption>Figure 29.1. Flow Definition (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def DroneSystem :&gt; CommonUAVSystem {
 2     event occurrence msgHeatReceive;
 3     event occurrence msgLightReceive;
 4     event occurrence msgHumidityReceive;
 5 }
 6 package Actors {
 7     part def Environment :&gt; DSBA::&#39;UAV Environment&#39; {
 8         event occurrence msgHeatSend;
 9         event occurrence msgLightSend;
10         event occurrence msgHumiditySend;
11     }
12 }</code></pre>
</div>
<figcaption>Figure 29.2. Event Occurrences (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def DroneSystemContext :&gt; CommonUAVSystemContext {
 2     part droneSystem : DroneSystem :&gt;&gt; uavSystem;
 3     part environment : Actors::Environment :&gt;&gt; environment;
 4     
 5     // Different uses of Messages 
 6     message lightExchange of DSD::Light 
 7       from environment.msgLightSend 
 8       to droneSystem.msgLightReceive;    
 9     message humidityExchange 
10       from environment.msgHumiditySend 
11       to droneSystem.msgHumidityReceive;
12     message heatExchange : Interfaces::HeatFlow 
13       from environment.msgHeatSend 
14       to droneSystem.msgHeatReceive;
15 }
16 package &lt;DSD&gt; Drone_SystemDomain {
17     item def Light;
18 }
19 package Interfaces {
20     abstract flow def HeatFlow {
21         ref item heat :&gt; ISQ::heat :&gt;&gt; payload;
22     }
23 }</code></pre>
</div>
<figcaption>Figure 29.3. Message (Textual Notation)</figcaption>
</figure>
</figure>
...
|                                                                                                                                            | <figure class="code" lang="en" dir="ltr">                                                                                                                                                                                                                                                                                                              |
|                                                                                                                                            | <div class="highlight">                                                                                                                                                                                                                                                                                                                                |
|                                                                                                                                            | <pre><code>1 part def DroneSystemContext {                                                                                                                                                                                                                                                                                                             |
|                                                                                                                                            | 2     part droneSystem;                                                                                                                                                                                                                                                                                                                                |
|                                                                                                                                            | 3     part environment;                                                                                                                                                                                                                                                                                                                                |
|                                                                                                                                            | 4     message of HeatEnergy from environment to droneSystem;                                                                                                                                                                                                                                                                                           |
|                                                                                                                                            | 5 }                                                                                                                                                                                                                                                                                                                                                    |
|                                                                                                                                            | 6 item def HeatEnergy;</code></pre>                                                                                                                                                                                                                                                                                                                    |
|                                                                                                                                            | </div>                                                                                                                                                                                                                                                                                                                                                 |
|                                                                                                                                            | </figure>                                                                                                                                                                                                                                                                                                                                              |
|                                                                                                                                            | </figure>                                                                                                                                                                                                                                                                                                                                              |
|                                                                                                                                            |                                                                                                                                                                                                                                                                                                                                                        |
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 use case def &#39;Observe Area by Drone&#39; {
 2     subject droneSystem {
 3         event occurrence msgObsAreaReceive;
 4         event occurrence msgFlightConfigReceive;
 5         event occurrence msgObsDataSent;
 6         event occurrence msgSigReturnHomeReceive;
 7     }
 8     actor operator {
 9         event occurrence msgObsAreaSent;
10         event occurrence msgFlightConfigSent;
11         event occurrence msgObsDataReceive;
12         event occurrence msgSigReturnHomeSent;
13     }
14     actor environment;
15 
16     message msgObsArea of ObservationArea 
17         from operator.msgObsAreaSent to droneSystem.msgObsAreaReceive;
18     message msgFlightConfig of FlightConfiguration
19         from operator.msgFlightConfigSent to droneSystem.msgFlightConfigReceive;
20     message msgObsData of ObservationData
21         from droneSystem.msgObsDataSent to operator.msgObsDataReceive;
22     message msgReturnHome of SigReturnHome
23         from operator.msgSigReturnHomeSent to droneSystem.msgSigReturnHomeReceive;
24 
25     first msgObsArea then msgFlightConfig;
26     first msgFlightConfig then msgObsData;
27     first msgObsData then msgReturnHome;
28 }
29 
30 item def ObservationArea;
31 item def FlightConfiguration;
32 item def ObservationData;
33 item def SigReturnHome;</code></pre>
</div>
<figcaption>Figure 29.5. Messages in a Use Case (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def DroneSystemContext :&gt; DSBA::CommonUAVSystemContext {
 2     part droneSystem : DroneSystem :&gt;&gt; uavSystem;
 3     part environment : Actors::Environment :&gt;&gt; environment;
 4     message heatExchange : HeatFlow 
 5         from environment.msgHeatSend 
 6         to droneSystem.msgHeatReceive;
 7     interface heatIF : Interfaces::HeatIF 
 8         connect environment.heatPort 
 9         to droneSystem.heatPort;
10     flow environment.humidityPort.humidity 
11         to droneSystem.humidityPort.humidity;
12 }
13 part def DroneSystem :&gt; DSBA::CommonUAVSystem {
14     port heatPort : ~Interfaces::HeatPort;
15     port humidityPort : ~Interfaces::HumidityPort;
16     event occurrence msgHeatReceive;
17 }
18 package Actors {
19     part def Environment :&gt; DSBA::&#39;UAV Environment&#39; {
20         port heatPort : Interfaces::HeatPort;
21         port humidityPort : Interfaces::HumidityPort;
22         event occurrence msgHeatSend;
23     }
24 }
25 package Interfaces {
26     // Flows
27     abstract flow def HeatFlow {
28         ref item heat :&gt; ISQ::heat :&gt;&gt; payload;
29     }
30     flow def HeatInterfaceFlow :&gt; HeatFlow {
31         end heatPortSource : Interfaces::HeatPort;
32         end heatPortTarget : Interfaces::HeatPort;
33     }
34     // Interfaces
35     interface def HeatIF {
36         end envHeatPort : HeatPort;
37         end droneSystemHeatPort : ~HeatPort;
38         flow heatExchangeFlow : HeatInterfaceFlow 
39             from envHeatPort.heatEnergy 
40             to droneSystemHeatPort.heatEnergy;
41     }
42     // Ports
43     port def HeatPort {
44         out item heatEnergy : ISQ::EnergyValue;
45     }
46     port def HumidityPort {
47         out item humidity;
48     }
49 }</code></pre>
</div>
<figcaption>Figure 29.8. Streaming Flow (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 use case def &#39;Observe area by drone&#39; {
 2     subject droneSystem : DSS::DroneSystem;
 3     actor operator : DSS::Actors::Operator;
 4     objective {
 5         doc /* The drone system autonomously observes 
 6              * a defined area and reports any incidents. */
 7     }
 8     first start then specifyArea;
 9     succession flow specifyArea.obsArea to flyToPosition.obsArea;
10     first flyToPosition then observeArea;
11     first observeArea then done;
12     perform action specifyArea { out item obsArea : DSD::ObservationArea; }
13     perform action flyToPosition { in item obsArea : DSD::ObservationArea; }
14     perform action observeArea;
15 }</code></pre>
</div>
<figcaption>Figure 29.10. Succession Flow (Textual Notation)</figcaption>
</figure>
</figure>
::::::
:::::::::::::::::::::::::::::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 attribute numberOfEngines : ScalarValues::Integer = 4;
2 attribute maxSpeed : ScalarValues::Rational = 1.5E+2;
3 attribute callSign : ScalarValues::String = &quot;Sentinel5&quot;;
4 attribute numberOfRotors = numberOfEngines;</code></pre>
</div>
...
:::
    ...
    Operator    Description
  ------------- -----------------------------
      a & b     Conjunction (logical *and*)
     a \| b     Disjunction (logical *or*)
...
:::
                   ...
                   Group Functions
  ---------------------- ---------------------------------------------------------------------------------
                Extremum min(x, y), max(x, y)
               Magnitude abs(x)
             Aggregation sum, product
       String conversion ToString(x), ToComplex(s), ToReal(s), ToRational(s), ToInteger(s), ToNatural(s)
    Numerical conversion floor(x), round(x), ToNatural(x), ToInteger(x), ToRational(x), ToReal(x)
      Rational functions rat(numer, denum), numer(x), denum(x), gcd(x, y)
       Complex functions rect(re, im), polar(abs, arg), re(x), im(x), abs(x), arg(x)
          Real functions sqrt(x)
        String functions \+ *(concatenation operator)*, Length(s), Substring(s, start, end)
::::
:::::::::::::::::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def MissionController {
 2     private import ScalarValues::Real;
 3     private import ScalarValues::Integer;
 4     attribute heightWaypoints [*] : Real = (0, 100.0, 110.5, 0);
 5     attribute completedWaypoints [*] : Real := null;
 6     attribute missedWaypoints [*] : Real := ();
 7     attribute remainingWaypoints [*] : Real := heightWaypoints;
 8     attribute waypointIndices [*] : Integer = 1..4;
 9     item allMissionControllers [*] = all MissionController;
10 }</code></pre>
</div>
<figcaption>Figure 30.3. Sequence Terms (Textual Notation)</figcaption>
</figure>
</figure>
...
:::
            ...
            Group Functions
  --------------- ----------------------------------------------------------------------------------------------------------------------------------------------------
       Comparison equals, same (for occurrences, see [#s](#all_chapter_contents.xhtml_p2-Expressions-Handling-Complex-Structures)), includes, includesOnly, excludes
             Size size(s), isEmpty(s), notEmpty(s)
      Combination union(s1, s2), intersection(s1, s2), including(s1, s2), includingAt(s1, s2, idx), excluding(s1, s2), excludingAt(s, start, end)
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 calc def NominateLeader {
2     in part activeDrones [*];
3     activeDrones#(1)
4 }</code></pre>
</div>
<figcaption>Figure 30.4. The Indexing Operator (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 calc def GetLeaderCallsign {
2     in part activeDrones [*] {
3         attribute callsign : ScalarValues::String;
4     }
5     activeDrones#(1).callsign ?? &quot;&lt;none&gt;&quot;
6 }</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 attribute def MotionParameters {
2     attribute airspeed :&gt; ISQ::speed;
3     attribute verticalSpeed :&gt; ISQ::speed default 0.0 [SI::&#39;m/s&#39;];
4 }
5 attribute currentStatus = new MotionParameters(8.0 [SI::&#39;m/s&#39;], 2.1 [SI::&#39;m/s&#39;]);
6 attribute partialStatus = new MotionParameters(airspeed = 0.0 [SI::&#39;m/s&#39;]);
7 attribute currentAirspeed = currentStatus.airspeed;</code></pre>
</div>
<figcaption>Figure 30.6. Constructor and Feature Chain Expressions (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 part drones [*];
2 attribute leaderExists = SequenceFunctions::notEmpty(drones);
3 part leader = NominateLeader(activeDrones = drones);</code></pre>
</div>
<figcaption>Figure 30.7. Invoking a Function or Calculation (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 action def SetUp {
2     out part drones [*];
3     out calc nominateLeader : NominateLeader {
4         in activeDrones = drones;
5     }
6 }
7 action setup = SetUp();
8 part drones [*] = setup.drones;
9 part leader = setup.nominateLeader();</code></pre>
</div>
<figcaption>Figure 30.8. Invoking a Usage or an Action (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 calc def SelectLeader {
2     private import SequenceFunctions::excluding;
3     in part activeDrones [*];
4     in part damagedDrones [*];
5     activeDrones-&gt;excluding(damagedDrones)-&gt;NominateLeader()
6 }</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 part def LeaderSelector {
2     private import SequenceFunctions::*;
3 
4     attribute preferFirst : ScalarValues::Boolean;
5     calc nominateFirst = { in part drones; drones-&gt;head() };
6     calc nominateLast = { in part drones; drones-&gt;tail() };
7     calc nominate = if preferFirst ? nominateFirst else nominateLast;
8 }</code></pre>
</div>
...
<div class="highlight">
<pre><code> 1 part def Drone {
 2     item currentTarget;
 3     item pastTargets [*];
 4     item successfulTargets [*] :&gt; pastTargets;
 5     item failedTargets [*] :&gt; pastTargets;
 6     item abortedTargets [*] :&gt; pastTargets;
 7 }
 8 calc def GetAbortedTargets {
 9     in part drone : Drone;
10     drone.abortedTargets
11 }
12 action def CollectDroneTargets {
13     private import ControlFunctions::collect;
14     in part drones [*] : Drone;
15     out item current [*] = collect(drones, {in drone [1] : Drone; drone.currentTarget});
16     out item past [*] = drones-&gt;collect({in drone [1] : Drone; drone.pastTargets});
17     out item succeeded = drones-&gt;collect{in drone [1] : Drone; drone.successfulTargets};
18     out item failed = drones.{in drone [1] : Drone; drone.successfulTargets};
19     out item aborted = drones-&gt;collect GetAbortedTargets;
20 } </code></pre>
</div>
<figcaption>Figure 30.11. Various Notations for the Collect Function (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 part def Drone {
 2     attribute isDamaged : ScalarValues::Boolean;
 3 }
 4 action def PartitionDroneTargets {
 5     private import ControlFunctions::*;
 6     in part drones [*] : Drone;
 7     out part damaged [*] = drones.?{in drone [1] : Drone; drone.isDamaged};
 8     out part leader = drones-&gt;selectOne({in drone [1] : Drone; not drone.isDamaged});
 9     out part intact [*] = drones-&gt;reject({in drone [1] : Drone; drone.isDamaged});
10 }</code></pre>
</div>
<figcaption>Figure 30.12. Select, SelectOne, and Reject (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 attribute def MissionData {
 2     attribute time :&gt; ISQ::duration;
 3     attribute cost : ScalarValues::Real;
 4 }
 5 calc def AggregateMissionData {
 6     private import ControlFunctions::reduce;
...
<figcaption>Figure 30.13. The Reduce Function (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def DroneNetwork {
 2     private import ControlFunctions::*;
 3     private import SequenceFunctions::*;
 4     part drones [*] {
 5         ref part connectedTo [*] : Drone;
 6         attribute commsOnline : ScalarValues::Boolean;
 7         attribute connectedToBase : ScalarValues::Boolean;
 8     }
 9     assert constraint allDronesConnected { 
10         drones-&gt;forAll({in drone :&gt; drones; drone.connectedTo-&gt;notEmpty()}) 
11     }
12     assert constraint oneDroneConnectedToAll { 
13         drones-&gt;exists({in drone :&gt; drones; drone.connectedTo-&gt;includes(drones)}) 
14     }
15     assert constraint allDronesOnline {
16         drones.commsOnline-&gt;allTrue()
17     }
18     assert constraint oneDroneConnectedToBase {
19         drones.connectedToBase-&gt;anyTrue()
20     }
21 }</code></pre>
</div>
<figcaption>Figure 30.14. Quantification Functions (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 constraint def PowerConstraint {
 2     in part powerConsumers : PowerConsumer[*];
 3     in part powerProducer : PowerProducer;
 4 
 5     attribute totalPowerUsage :&gt; ISQ::electricPower 
 6       = QuantityCalculations::sum(powerConsumers.maxPowerUse);
 7 
 8     totalPowerUsage &lt;= powerProducer.maxPower
 9 }
10 part def PowerProducer {
11     attribute maxPower :&gt; ISQ::electricPower;
12 }
13 part def PowerConsumer {
14     attribute maxPowerUse :&gt; ISQ::electricPower;
15 }</code></pre>
</div>
<figcaption>Figure 31.2. Constraint Definition (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 connection def PowerDistribution {
2     end producer[1] part powerSource : PowerProducer;
3     end consumers[1..*] part powerTarget : PowerConsumer;
4 
5     assert constraint powerConsumption : PowerConstraint {
6         in part :&gt;&gt; powerConsumers = powerTarget;
7         in part :&gt;&gt; powerProducer = powerSource;
8     }
9 }</code></pre>
</div>
<figcaption>Figure 31.3. Constraint Usage (Textual Notation)</figcaption>
</figure>
</figure>
...
3     end consumers[1..*] part powerTarget : PowerConsumer;
4 
5     assert not constraint powerConsumption : PowerConstraint {
6         in part :&gt;&gt; powerConsumers = powerTarget;
7         in part :&gt;&gt; powerProducer = powerSource;
8     }
9 }</code></pre>
</div>
<figcaption>Figure 31.4. Inverted Assert Constraint (Textual Notation)</figcaption>
</figure>
</figure>
:::::::::
...
2     part airTrafficControlAuthority : DSNEEDS::&#39;Air Traffic ControlAuthority&#39;;
3     part uavSpecialist : DSNEEDS::&#39;UAV Specialist&#39; {
4         attribute :&gt;&gt; risk = risk::high;
5         attribute :&gt;&gt; effort = risk::low;
6         attribute :&gt;&gt; kind = kind::Expert;
7         attribute :&gt;&gt; contact = &quot;u.av@mbse4u.com&quot;;
8     }
9 }</code></pre>
</div>
<figcaption>Figure 32.2. Model Project with Stakeholders (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &lt;DSRE&gt; Drone_Requirements {
 2     requirement def UAVSystemRequirements {
 3         subject theUAV : CommonUAV;
 4         requirement &lt;REQ2&gt; uavFlightTime : CommonRequirement {
 5             doc /* When standard conditions apply, 
 6                 the UAV shall fly for at least 2 hours. */
 7             subject theUAV : CommonUAV;
 8             stakeholder uavExpert : CommonStakeholder;
 9         }
10         requirement &lt;REQ3&gt; maximumTakeOffWeight : CommonRequirement {
11             subject theUAV : CommonUAV;
12             stakeholder uavExpert : CommonStakeholder;
13             require constraint {
14                 language &quot;English&quot; 
15                 /* The maximum takeoff weight shall not exceed 42 kg. */
16             }
17         }
18         requirement &lt;REQ23&gt; observeArea : CommonRequirement {
19             doc /* The drone must be able to monitor a defined area. */
20             subject theUAV : CommonUAV;
21             stakeholder uavExpert : CommonStakeholder;
22         }
23     }
24 }
25 occurrence def UAVProject {
26     part stakeholders [*] : CommonStakeholder;
27     part airTrafficControlAuthority :&gt; stakeholders;
28     part uavSpecialist :&gt; stakeholders;
29     
30     part droneSystemContext : DSRE::DroneSystemContext;
31 
32     requirement uavSystemRequirements : DSRE::TextualRequirements::UAVSystemRequirements {
33         requirement :&gt;&gt; uavFlightTime {
34             stakeholder :&gt;&gt; uavExpert = uavSpecialist;
35         }
36         requirement :&gt;&gt; maximumTakeOffWeight {
37             stakeholder :&gt;&gt; uavExpert = uavSpecialist;
38         }
39         requirement :&gt;&gt; observeArea {
40             stakeholder :&gt;&gt; uavExpert = uavSpecialist;
41         }
42     }            
43 }</code></pre>
</div>
<figcaption>Figure 32.4. Textual Requirement (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 library package MBSEMethodology {
 2     requirement def CommonRequirement {
 3         attribute priority : LevelKind;
 4         attribute stability : StabilityKind;
 5         attribute kind : RequirementKind;
 6     }
 7     enum def StabilityKind {
 8         stable;
 9         unstable;
10         undefined;
11     }
12     enum def RequirementKind {
13         functional;
14         performance;
15         safety;
16         legal;
...
<figcaption>Figure 32.6. Common Requirement (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &lt;DSBA&gt; &#39;DroneSystem_Base Architecture&#39; {
 2     part def CommonUAV {
 3         attribute maxFlightTime :&gt; ISQ::duration;
 4         attribute actualMass :&gt; ISQ::mass;
 5         attribute callSign : ScalarValues::String;
 6     }
 7     part def &#39;UAV Environment&#39; {
 8         attribute windSpeed :&gt; ISQ::speed;
 9     }
10 }
11 package &lt;DSRE&gt; &#39;DroneSystem_System Requirements&#39; {
12     requirement def UAVSystemRequirements {
13         subject theUAV : DSBA::CommonUAV;
14         requirement &lt;REQ2&gt; uavFlightTime : CommonRequirement {
15             doc 
16             /* When standard conditions apply, the UAV shall fly for at least 2 hours. */
17             subject uav : DSBA::CommonUAV;
18             stakeholder uavExpert : DSNEEDS::&#39;UAV Specialist&#39;;
19             actor uavEnvironment : DSBA::&#39;UAV Environment&#39;;
20             attribute :&gt;&gt; priority = priority::high;
21             attribute :&gt;&gt; stability = stability::stable;
22             attribute :&gt;&gt; kind = kind::performance;
23             require constraint {
24                 uav.maxFlightTime &gt;= 120 [SI::min]
25             }
26             assume constraint {
27                 uavEnvironment.windSpeed &lt;= 20 [SI::&#39;km/h&#39;]
28             }
29         }
30     }
31 }</code></pre>
</div>
<figcaption>Figure 32.11. Modeled Requirement (Textual Notation)</figcaption>
</figure>
</figure>
:::::::::::::
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &lt;DPA&gt; &#39;Drone_Physical Architecture&#39; {
 2     part def Drone :&gt; CommonUAV {
 3         attribute :&gt;&gt; actualMass = 50 [SI::kg];
 4         attribute :&gt;&gt; maxFlightTime = 150 [SI::min];
 5     }
 6 }
 7 
 8 occurrence def UAVProject {
 9     requirement uavSystemRequirements : DRE::UAVSystemRequirements by theDrone;
10     part theDrone : DPA::Drone {
11         satisfy uavSystemRequirements.REQ2;
12     }
13     satisfy uavSystemRequirements.REQ3 by theDrone;
14 }</code></pre>
</div>
<figcaption>Figure 32.12. Satisfaction of Requirements (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &lt;DSNEEDS&gt; &#39;Drone System Stakeholder Needs&#39; {
 2     concern def &#39;Real-time Position Tracking&#39; {
 3         subject uav : DSBA::CommonUAV;
 4         stakeholder airTrafficControlAuthority : &#39;Air Traffic Control Authority&#39;;
 5         require constraint {
 6             doc /* Real-time UAV position tracking to maintain situational awareness 
 7                  * and ensure separation from other airspace users. */
 8         }
 9     }
10     concern def &#39;Modular Payload Integration&#39; {
11         subject uav : DSBA::CommonUAV;
12         stakeholder uavSpecialist : &#39;UAV Specialist&#39;;
13         require constraint {
14             doc /* Modular payload integration support to allow flexible mission-specific 
15                  * sensor or equipment configurations. */
16         }
17     }
18 }
19 package &lt;DSRE&gt; &#39;Drone System Requirements&#39; {
20     requirement def UAVSystemRequirements {
21         requirement &lt;REQ41&gt; realTimePosition : MBSEMethodology::CommonRequirement {
22             doc /* The UAV shall provide real-time position, velocity, and flight status 
23                  * updates at a rate of no less than 1 Hz to the Air Traffic Control 
24                  * system over a secure communication link. */
25             subject theUAV : DSBA::CommonUAV;
26             frame concern positionTracking : DSNEEDS::&#39;Real-time Position Tracking&#39;;
27             attribute :&gt;&gt; priority = priority::high;
28             attribute :&gt;&gt; stability = stability::stable;
29         }
30         requirement &lt;REQ50&gt; modularPayloads : MBSEMethodology::CommonRequirement {
31             doc /* The UAV shall support integration of modular payloads through a 
32                  * standardized electrical and data interface, allowing plug-and-play 
33                  * compatibility with at least three different sensor types without 
34                  * requiring software reconfiguration. */
35             subject theUAV : DSBA::CommonUAV;
36             frame concern modularPayload : DSNEEDS::&#39;Modular Payload Integration&#39;;
37             attribute :&gt;&gt; priority = priority::middle;
38             attribute :&gt;&gt; stability = stability::stable;
39         }
40     }    
41 }
42 package &lt;DSP&gt; &#39;Drone System Project&#39; {
43     occurrence def UAVProject {
44         concern stakeholderNeeds : DSNEEDS::StakeholderNeeds;
45         part droneSystemContext : DSS::DroneSystemContext;
46         requirement uavSystemRequirements : DSRE::UAVSystemRequirements {
47             requirement :&gt;&gt; realTimePosition {
48                 subject :&gt;&gt; theUAV :&gt; droneSystemContext.droneSystem;
49                 frame concern :&gt;&gt; positionTracking 
50                     = stakeholderNeeds.realTimePositionTracking;
51             }
52             requirement :&gt;&gt; modularPayloads {
53                 subject :&gt;&gt; theUAV :&gt; droneSystemContext.droneSystem;
54                 frame concern :&gt;&gt; modularPayload 
55                     = stakeholderNeeds.modularPayloadIntegration;
56             }
57         }
58     }
59 }</code></pre>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def Person;
 2 part def TestPilot :&gt; Person;
 3 part def Auditor :&gt; Person;
 4 
 5 case def DroneTest {
 6     subject drone : Drone;
 7     actor pilot : Person;
 8     actor observer : Person;
 9     objective pilotDrone {
10         doc /* Test how the drone flies. */
11     }
12 }
13 
14 part def DroneClientTestContext {
15     part client : Person;
16     part prototype : Drone;
17     
18     case betaTest : DroneTest {
19         subject = prototype;
20         actor :&gt;&gt; pilot = client;
21         actor :&gt;&gt; observer = client;
22     }
23 }
24 
25 part def DroneCertificationContext {
26     part testPilot : TestPilot;
27     part auditor : Auditor;
28     part prototype : Drone;
29     
30     case certificationTest : DroneTest {
31         subject = prototype;
32         actor :&gt;&gt; pilot = testPilot;
33         actor :&gt;&gt; observer = auditor;
34     }
35 }</code></pre>
</div>
<figcaption>Figure 33.1. A Case and Two Contexts (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def BetaTestContext {
 2     part client : Person;
 3     part prototype : Drone;
 4     
 5     case betaTest {
 6         subject = prototype;
 7         actor client = BetaTestContext::client;
 8         objective pilotDrone {
 9             doc /* Test how the drone flies. */
10         }
11     }
12 }
13 
14 case def DroneCertification :&gt; DroneTest {
15     subject drone : Drone;
16     actor :&gt;&gt; pilot : TestPilot;
17     actor :&gt;&gt; observer : Auditor;
18 }</code></pre>
</div>
<figcaption>Figure 33.3. Alternatives to Modeling Cases (Textual Notation)</figcaption>
</figure>
</figure>
...
<div class="highlight">
<pre><code> 1 use case def &#39;Observe area by drone&#39; {
 2     subject droneSystem : DroneSystem;
 3     actor operator : Operator;
 4     objective {
 5         doc /* The drone system autonomously observes
 6              * a defined area and reports any incidents. */
 7     }
 8     first start;
 9     then perform action specifyArea;
10     then perform action flyToPosition;
11     then perform action observeArea;
12     then done;
13 }
14 
15 part def SystemContext {
16     part system : DroneSystem;
17     part op : Operator;
18     use case observe : &#39;Observe area by drone&#39; {
19         subject :&gt;&gt; droneSystem = system;
20         in :&gt;&gt; operator = op;
21     }
22     use case operationCycle {
23         subject droneSystem = system;
24         actor operator = op;
25         objective {
26             doc /* After every observation mission
27                  * the drone undergoes maintenance. */
28         }
29         first start;
30         then include observe;
31         then perform action maintenance;
32         then done;
33     }
34 }</code></pre>
</div>
<figcaption>Figure 33.5. Use Cases and Include Use Case (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def SystemContext {
 2 	use case uc1;
 3 	use case uc2 {
 4 		// CORRECT: next two lines parse into unnamed include use case usage 
 5 		// referring to &#39;uc1&#39; (however, effective name is still &#39;uc1&#39;, so lines
 6 		// 8, 9, and 15 will cause warning for duplicate names)
 7 		include uc1;
 8 		include use case references uc1;
 9 		// CORRECT: parses into include use case usage called &#39;include_uc1&#39; 
10 		// referring to &#39;uc1&#39;
11 		include use case include_uc1 references uc1;
12 		// INCORRECT: parses into use case usage named &#39;uc1&#39; that is NOT 
13 		// referring to &#39;uc1&#39; in the outer scope
14 		include use case uc1;
15 	}
16 }</code></pre>
</div>
<figcaption>Figure 33.7. Correct and Incorrect Ways to Declare Include Use Case Usages</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def SystemContextReaization :&gt; SystemContext {
 2     part :&gt;&gt; system {
 3         action flyToPosition;
 4         action observeArea;
 5     }
 6     part :&gt;&gt; op {
 7         action specifyArea;
 8     }
 9     use case :&gt;&gt; observe {
10         // All of these are legal notations with the same meaning
11         :&gt;&gt; specifyArea ::&gt; op.specifyArea;
12         action redefines flyToPosition references system.flyToPosition;
13         perform action :&gt;&gt; observeArea references system.observeArea;
14     }
15 }</code></pre>
</div>
<figcaption>Figure 33.8. Realization of Use Case Events By System and Actor Behaviors (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 analysis def MaxSpeedAnalysis {
 2     subject vehicle {
 3         attribute maxAcceleration :&gt; ISQ::acceleration;
 4     }
 5     objective {
 6         doc /* The objective of this analysis case is to calculate
 7              * maximum speed (vmax) a vehicle can achieve over a given
 8              * distance (d) starting at an initial speed (v0) with a
 9              * given acceleration (a), assuming the speeds are low
10              * enough to ignore drag.
11              */
12         assume constraint { vmax &lt; 100 [SI::&#39;km/h&#39;] }
13         assume constraint { vehicle.maxAcceleration &gt; 0 }
14     }
15     in attribute v0 :&gt; ISQ::speed;
16     in attribute d :&gt; ISQ::distance;
17     attribute t :&gt; ISQ::duration;
18     return vmax :&gt; ISQ::speed;
19 
20     assert constraint maxSpeed { vmax == v0 + vehicle.maxAcceleration * t }
21     assert constraint distance { d == v0 * t + vehicle.maxAcceleration * t^2 / 2 }
22 }</code></pre>
</div>
<figcaption>Figure 33.10. Analysis Definition (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 analysis def DroneMaxSpeedAnalysis :&gt; MaxSpeedAnalysis {
 2     subject drone :&gt;&gt; vehicle : DroneSystem {
 3         :&gt;&gt; maxAcceleration = maxHorizontalForce / mass;
 4     }
 5 }
 6 
 7 occurrence def DroneProject {
 8     part system : DroneSystem;
 9     analysis droneMaxSpeedAnalysis : MaxSpeedAnalysis {
10         subject :&gt;&gt; vehicle :&gt; system.drones {
11             :&gt;&gt; maxAcceleration = maxHorizontalForce / mass;
12         }
13     }
14 }</code></pre>
</div>
<figcaption>Figure 33.12. Analysis Case Concretization and Usage (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 verification def PowerUpTest {
 2     subject drone : Drone;
 3     objective checkPowerUp {
 4         verify requirement : DronePowerUpRequirement;
 5     }
 6 
 7     perform drone.powerUp;
 8     then perform action selftest references drone.selfTest;
 9     
10     return verdict = VerificationCases::PassIf(selftest.allNominal);
11 }</code></pre>
</div>
<figcaption>Figure 33.14. Verification Case Modeling a Test (Textual Notation)</figcaption>
</figure>
</figure>
...
![Figure 34.1. Allocations (General View)](resources/images/part2/FigAllocations.png){alt="Allocations (General View)"}
:::::
...
<pre><code> 1 package &lt;DSPA&gt; &#39;Drone System Product Architecture&#39; {
 2     private import DronePartsCatalogue::*;
 3     part def Drone {
 4         variation part battery : Battery {
 5             variant part standardBattery {
 6                 attribute :&gt;&gt; totalMass = 1.6 [SI::kg];
 7             }
 8             variant part powerBattery {
 9                 attribute :&gt;&gt; totalMass = 2.2 [SI::kg];
10             }
11         }
12     }
13 }
14 library package DronePartsCatalogue {
15     part def Battery {
16         attribute totalMass :&gt; ISQ::mass;
17     }
18 }</code></pre>
</div>
<figcaption>Figure 35.3. Variation and Variants (Textual Notation)</figcaption>
</figure>
</figure>
...
<pre><code> 1 package &lt;DSPA&gt; &#39;Drone System Product Architecture&#39; {
 ...
 3         part battery : Battery;
 4     }
 5     variation part def Battery :&gt; DronePartsCatalogue::Battery {
 6         variant part standardBattery {
 7             attribute :&gt;&gt; totalMass = 1.6 [SI::kg];
 8         }
 9         variant part powerBattery {
10             attribute :&gt;&gt; totalMass = 2.2 [SI::kg];
11         }
12     }
13 }</code></pre>
</div>
<figcaption>Figure 35.4. Definition as Variation (Textual Notation)</figcaption>
</figure>
</figure>
...
10             }
11         }
12         variation part engines[4..6] {
13             variant part fourEngines[4];
14             variant part sixEngines[6];
15         }
16         assert constraint {
17             engines == engines::sixEngines 
18                 implies battery == battery::powerBattery
19         }
20     }
21 }</code></pre>
</div>
<figcaption>Figure 35.5. Variation Constraint (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 package &#39;Delivery Drone Product&#39; {
2     part def DeliveryDrone :&gt; DSPA::Drone {
3         part :&gt;&gt; battery = battery::powerBattery;
4         part :&gt;&gt; engines = engines::sixEngines;
5     }
6 }</code></pre>
</div>
<figcaption>Figure 35.6. Setting a variant (Textual Notation)</figcaption>
</figure>
</figure>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package &#39;Drone Feature Model&#39; {
 2     private import PLEML::*;
 3     #featureModel occurrence def DroneFeatureModel {
 4         #featureTree droneFeatureTree :&gt; featureTrees {
 5             #feature missionKind [1];
 6             #feature localMission :&gt; missionKind;
 7             #feature longRangeMission :&gt; missionKind;
 8         }
 9     }
10 }
11 
12 package &lt;DSPA&gt; &#39;Drone System Product Architecture&#39; {
13     private import DronePartsCatalogue::*;
14     part def Drone {        
15         variation part battery : Battery {
16             variant part standardBattery {
17                 attribute :&gt;&gt; totalMass = 1.6 [SI::kg];
18             }
19             variant part powerBattery {
20                 attribute :&gt;&gt; totalMass = 2.2 [SI::kg];
21             }
22         }
23         variation part engines[4..6] {
24             variant part fourEngines[4];
25             variant part sixEngines[6];
26         }
27         assert constraint {
28             engines == engines::sixEngines 
29                 implies battery == battery::powerBattery
30         }        
31     }
32 }
33 occurrence def &#39;Drone Product Line Project&#39; {
34     private import PLEML::*;
35     
36     occurrence featureModel : &#39;Drone Feature Model&#39;::DroneFeatureModel;
37     part drone : DSPA::Drone;
38 
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 part def &#39;Systems Engineer&#39;;
 2 
 3 concern def &#39;Requirements Overview&#39; {
 4     stakeholder se : &#39;Systems Engineer&#39;;
 5     require constraint {
 6         doc /* Overview of the top-level Requirements. */
 7     }
 8 }
 9 
10 concern def &#39;Architecture Overview&#39; {
11     stakeholder se : &#39;Systems Engineer&#39;;
12     require constraint {
13         doc /* Overview of the system parts and 
14              * their connections. */
15     }
16 }
17 
18 viewpoint def &#39;Requirement Perspective&#39; {
19 
20     frame requirementConcern : &#39;Requirements Overview&#39;;
21 
22     require constraint {
23         doc
24         /* A view conforming to this viewpoint shall present the
25          * top-level system requirements, their intent, and their
26          * relationships (e.g., refinement or derivation), without
27          * detailing internal architectural realization.
28          */
29     }
30 }
31 
32 viewpoint def &#39;Architecture Perspective&#39; {
33 
34     frame architectureConcern : &#39;Architecture Overview&#39;;
35 
36     require constraint {
37         doc
38         /* A view conforming to this viewpoint shall present the
39          * top-level architectural elements of the system and
40          * their connections, focusing on structure and interaction
41          * rather than detailed behavior or implementation.
42          */
43     }
44 }
45 
46 viewpoint def &#39;Top-Level System Perspective&#39; {
47 
48     viewpoint requirementPerspective : &#39;Requirement Perspective&#39;;
49     viewpoint architecturePerspective : &#39;Architecture Perspective&#39;;
50     
51     require constraint {
52         doc /* A view shall show the top-level parts of 
53              * the architectures and how they connected,
54              * and the top-level requirements.  */
55     }
56 }</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 view def &#39;System Breakdown Structure&#39; {
 2     filter @SysML::PartUsage or @SysML::FeatureMembership;
 3     render Views::asTreeDiagram;
 4 }
 5 occurrence def UAVProject {
 6     view sbs : &#39;System Breakdown Structure&#39; {
 7         expose &#39;Drone System Product Architecture&#39;::*;
 8     }
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 library package &lt;PBSE&gt; PlatformBasedSystemsEngineering {
 2     occurrence def Function {
 3         occurrence realizingPlatforms : Platform [1];
 4     }
 5     occurrence def Platform {
 6         occurrence realizedFunctions : Function [*];
 7     }
 8     allocation def FunctionalAllocation {
 9         end occurrence function : Function crosses platform.realizedFunctions;
10         end occurrence platform : Platform crosses function.realizingPlatforms;
11     }
12 }</code></pre>
</div>
...
<div class="highlight">
<pre><code>1 part def Drone {
2     occurrence navigation : PBSE::Function;
3     occurrence navigationSubsystem : PBSE::Platform;
4     allocation : PBSE::FunctionalAllocation 
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 abstract occurrence functions : Function;
 2 abstract occurrence platforms : Platform;
 3 abstract allocation functionalAllocations : FunctionalAllocation;
 4 
 5 metadata def &lt;function&gt; FunctionMetadata :&gt; Metaobjects::SemanticMetadata {
 6     :&gt;&gt; baseType = functions meta SysML::Type;
 7 }
 8 metadata def &lt;platform&gt; PlatformMetadata :&gt; Metaobjects::SemanticMetadata {
 9     :&gt;&gt; baseType = platform meta SysML::Type;
10 }
11 metadata def &lt;functionalAllocation&gt; FunctionalAllocationMetadata :&gt; Metaobjects::SemanticMetadata {
...
5     #platform occurrence navigationSubsystem;
6     // Allocations
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 package Elements {
2     part def &lt;shortName&gt; DeclaredName {
3         item declaredName;
4     }
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package Dependencies {
 2     part def PartDef0;
 3     part def PartDef1;
 4     part def PartDef2;
 5     action def Action1;
 6 
 7     dependency actionUse from Action1 to PartDef0A, PartDef1;
 8     dependency from PartDef0 to PartDef1;
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package Comments {
 2     comment &lt;&#39;short name&#39;&gt; &#39;Name of the Comment&#39; 
 3         about PartA locale &quot;en_US&quot; 
 4         /* Comment text */
 5 
 6     part def PartA {
 7         /* Text about PartA */
 8         comment about PartB locale &quot;en_US&quot;
 9             /* Comment owned by PartA about PartB */
10     }
11     part def PartB {
12         comment todos /* 1. ..., 2. ... */
13     }
14 }</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package Documentation {
 2     part def PartA {
 3         doc /* Documentation of PartA */
 4     }
 5     part def PartB {
 6         doc &lt;b_doc&gt; &#39;The documentation of PartB&#39;
 7             locale &quot;en_US&quot;
 8             /* Documentation about PartB */
 9     }
10 }</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 calc def CalculationA {
2     rep textRep language &quot;python&quot; 
3     /* python code */
4 }</code></pre>
</div>
...
2 part def Drone {
3   part battery_OptionA : Battery;
4   // part battery_OptionB : Battery;
5 }
6 part def Battery;</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code>1 package P1 {
2   private package P2;
3   package P3;
4   part def PartDef1;  
5 }</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 library package P1Lib {
 2     part def PartDef1;
 3 }
 4 
 5 standard library package Parts {
 6     doc
 7     /*
 8     * This package defines the base types for parts and related structural elements in the
 9     * SysML language.
10     */
11     [...]
12 }</code></pre>
...
<pre><code>1 package P1 {
2     part def PartDef0;
3     alias PD0 for PartDef0;
4 }
5 package P2 {
6     alias &lt;PZero&gt; Part0 for P1::PartDef0;
7     private alias PrivP0 for P1::PartDef0;
8 
9 }</code></pre>
</div>
...
<figure class="code" lang="en" dir="ltr">
<div class="highlight">
<pre><code> 1 package RequirementDerivationExample {
 2     requirement def RequirementSpecification {
 3         private import RequirementDerivation::*;
 4         requirement req1;
 5         requirement req2;
 6         requirement req3;
 7         #derivation connection {
 8             end #original ::&gt; req1;
 9             end #derive ::&gt; req2;
10             end #derive ::&gt; req3;
11         }
...
[^1]: If you have a background in programming, you can compare this to "it compiles" versus "it runs (correctly)"---completely different things.

[^2]: <https://mbse-syson.org/>

[^3]: <https://sensmetry.com/syside/>

[^4]: <https://www.tomsawyer.com/sysml-v2-viewer>

[^5]: Unified Modeling Language ([OMG 2017a](#all_chapter_contents.xhtml_OMG2017a)); current version is 2.5.1; a version 3 is not planned yet.

[^6]: Business Process Model and Notation ([OMG 2014b](#all_chapter_contents.xhtml_OMG2014b)); current version is 2.0.2; a version 3 is not planned yet.

[^7]: Reification means that an abstract idea is represented by something concrete---in this case, a relationship between two things in the universe is also treated as an individual thing.

[^8]: Sometimes there are more than one usages corresponding to a definition. These may capture extra constraints (for example, a "PerformActionUsage" is a special kind of "ActionUsage" that is always referential, but requires the referred action to happen during the performer), or represent the usage of a specific library type (like "IfActionUsage", which is a usage of "IfThenAction" or "IfThenElseAction" from the Systems Library).

[^9]: There are plans to move enumerations into KerML in a later release.

[^10]: Normative parts represent the single source of truth for the specification. Non-normative parts are only descriptive or advisory---they are not relevant when checking conformance to the specification. This also means that if the normative and non-normative parts contradict, the normative part shall always "win".

[^11]: Most of the properties in the metamodel are derived either because they represent "shortcuts" across relationships or because they are computed (mostly filtered) from other properties.

[^12]: As a fun fact, we note that this validation rule can actually never be violated in correct implementations of SysML. Because of the "check" constraint, every "PartUsage" will specialize "Parts::parts" from the Semantic Library, which is defined by "Parts::Part"---a "PartDefinition".

[^13]: At the time of writing this book, the libraries are available in the "SysML-v2-Release" GitHub repository: <https://github.com/Systems-Modeling/SysML-v2-Release/tree/master/sysml.library>

[^14]: <https://www.pearsonvue.com/us/en/omg.html>
...
[^30]: It would also make perfect sense to see actions as special kinds of states representing that the action is currently executing. In fact, this level is also present in the core of the language---snapshots and timeslices represent portions of the component's lifetime, which can be aligned with actions or state machines to show when they are active.

[^31]: Note that there is only one kind of state in SysML, which may or may not have sub-states.

[^32]: A last-minute change before the release of SysML v2 allowed the payload of flows to be attributes (datatypes). While this seems convenient, it is semantically inconsistent with the abstract nature of datatypes---they do not exist in 4D, so they cannot really "flow" either. We prefer using items to model the actual representation that carries the information characterized by a datatype.

[^33]: The current version of the Cameo Systems Modeler does not support the graphical notation of "Messages" yet. Therefore, this view is created with a different tool. We will replace it as soon as it is supported by Cameo.
...
[^37]: The technical definition of feature chain expressions is somewhat more complex, which is reflected in the parsed model when accessed programmatically. In short, it always starts with an arbitrary expression (which can be a feature reference expression in the simplest case), then it will have a feature chain (not an expression!), which can have one or more parts. A longer chain, such as "droneSystem.drone.speed", will then become a single feature chain expression, with the primary expression referring to "droneSystem", and the feature chain will be "drone.speed".

[^38]: This is only for the sake of the example. An equivalent but better way would be to specify the body of the calculation usage the same way the function literal is defined (essentially by removing the "=").

[^39]: The "map" operation (without flattening) has no equivalent for sequences, since they are always flat. However, SysML includes a library of attribute definitions for collection types such as arrays or sets, which can be used for more complex data manipulation.
